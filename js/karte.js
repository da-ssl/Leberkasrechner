var Map = L.map('meineKarte').setView([48.044363, 11.966227], 14); //Layers mit Tileserver und Copyright-Anzeige verbinden 
...
var OpenStreetMap = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {maxZoom: 18, attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>-Mitwirkende'}).addTo(Map); //Layer definieren 
var baseMaps = { "OpenStreetMap": OpenStreetMap, "OpenstreetMap DE": OpenStreetMap_DE, "OpenTopoMap": OpenTopoMap, }; var overlayMaps = { "OpenRailwayMap": OpenRailwayMap, }; 
