...
class leberkasMap extends L.map {
    constructor (htmlId) {
        super(htmlId, {
            center: new L.LatLng(48.1372, 11.5796), 
            zoom: 10
        })

        var OpenStreetMap = L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {maxZoom: 19, attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>-Mitwirkende'}).addTo(this);
...
fetch('https://leberkasrechner.de/js/butchers.json')
    ...
    .then(jsonData => {
        butchers = jsonData;
        var lmap = new leberkasMap('kasmap')
    })
